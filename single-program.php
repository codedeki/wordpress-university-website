    ...
    //Events Custom Query
          ...
          $homepageEvents = new WP_Query(array(
            ...
            'meta_query' => array(
              ...
              array(
                'key' =>'related_programs', //In Programs, shows any posts that have a relationship with a specific program (e.g. show posts that have the field 'Biology")
                'compare'=>'LIKE',
                'value'=>'"'. get_the_ID() . '"' //must get the in quotes since wordpress db stores id's in quotes
              )
            )
        ...
        wp_reset_postdata(); //reset before providing new field
